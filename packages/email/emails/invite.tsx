  ...
  return (
    <Html>
      <Tailwind>
        ...
        <Preview>You've been invited to join Bubba AI</Preview>
        ...
        <Body className="bg-[#fff] my-auto mx-auto font-sans">
          ...
          >
            ...
            <Heading className="mx-0 my-[30px] p-0 text-[24px] font-normal text-[#121212] text-center">
              Join <strong>{teamName}</strong> on <strong>Bubba AI</strong>
            </Heading>

            <Text className="text-[14px] leading-[24px] text-[#121212]">
              You've been invited to join your team on <strong>Bubba AI</strong>
              .
            </Text>
